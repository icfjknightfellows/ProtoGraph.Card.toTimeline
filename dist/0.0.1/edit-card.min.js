	...
	var TimelineCard = function (_React$Component) {
	  ...
	  _createClass(TimelineCard, [{
	    ...
	    value: function componentDidUpdate() {
	      var events = Array.from(document.getElementsByClassName('single-event')),
	      ...
	      Array.from(document.getElementsByClassName('active')).forEach(function (e) {
	    ...
	    value: function renderLaptop() {
	      ...
	      if (this.state.fetchingData) {
	        ...
	        var topDate = data.data.events[0].single_event.timestamp_date,
	        ...
	        var genreColor = this.state.optionalConfigJSON.house_colour,
	        ...
	        var str = this.state.dataJSON.mandatory_config.url;
	        ...
	        return _react2.default.createElement(
	          'div',
	          { className: 'totimelinecard parent-card-desktop' },
	          _react2.default.createElement(
	            'div',
	            { className: 'first-view view' },
	            _react2.default.createElement(
	              'div',
	              { className: 'proto-col-3 view-in-desktop' },
	              _react2.default.createElement(
	                'div',
	                { className: 'card-tags' },
	                fav ? _react2.default.createElement(
	                  'div',
	                  { className: 'publisher-icon', style: { backgroundColor: this.state.dataJSON.mandatory_config.iconbgcolor || 'white' } },
	                  _react2.default.createElement('img', { className: 'favicon', src: fav })
	                ) : null,
	                _react2.default.createElement(
	                  'div',
	                  { className: 'series-name', style: { padding: padding } },
	                  series,
	                  genre ? _react2.default.createElement(
	                    'div',
	                    { className: 'genre', style: { backgroundColor: genreColor, color: genreFontColor, marginLeft: series ? '3px' : '0px' } },
	                    genre,
	                    ' '
	                  ) : null
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'sub-genre-dark', style: { fontStyle: this.state.dataJSON.mandatory_config.sponsored ? 'italic' : 'normal', textDecoration: this.state.dataJSON.mandatory_config.sponsored ? 'underline' : 'none' } },
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  { onClick: function onClick() {
	                      document.getElementsByClassName('totimelinecard')[0].classList.add('flipped');_this3.setState({ ready: true });
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'second-view view' },
	            _react2.default.createElement(
	              'div',
	              { className: 'proto-col-3 view-in-desktop', style: { opacity: "0.3" } },
	              _react2.default.createElement('div', { className: 'tag-area' }),
	              _react2.default.createElement(
	                'div',
	                { className: 'cover-content', style: { bottom: 52 } },
	                _react2.default.createElement(
	                  'div',
	                  { className: 'title' },
	                  data.mandatory_config.timeline_title
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                { className: 'progress-line', id: 'progress_desktop' },
	                _react2.default.createElement(
	                  'div',
	                  { className: 'progress-start-lable' },
	                  topLabel
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'progress-container' },
	                  _react2.default.createElement('div', { className: 'progress-after', style: { height: percent } }),
	                  _react2.default.createElement('div', { className: 'progress' })
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'progress-end-lable' },
	                  bottomLabel
	                )
	              ),
	              _react2.default.createElement(
	                  ...
	                  data.data.events.map(function (d, i) {
	                    ...
	                    return _react2.default.createElement(
	                      ...
	                      d.single_event.photo && _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('img', { src: d.single_event.photo, style: { height: "100%", width: "100%" } })
	                      ),
	                      _react2.default.createElement(
	                        'p',
	                        null,
	    ...
	    value: function renderMobile() {
	      ...
	      if (this.state.fetchingData) {
	        ...
	        return _react2.default.createElement(
	          'div',
	          { className: 'totimelinecard parent-card-mobile' },
	          _react2.default.createElement(
	            'div',
	            { className: 'first-view view' },
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'div',
	                  { className: 'card-tags', style: { position: "absolute", top: 0 } },
	                  fav ? _react2.default.createElement(
	                    'div',
	                    { className: 'publisher-icon', style: { backgroundColor: this.state.dataJSON.mandatory_config.iconbgcolor || 'white' } },
	                    _react2.default.createElement('img', { className: 'favicon', src: fav })
	                  ...
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'sub-genre-light', style: { fontStyle: this.state.dataJSON.mandatory_config.sponsored ? 'italic' : 'normal', textDecoration: this.state.dataJSON.mandatory_config.sponsored ? 'underline' : 'none' } },
	                    this.state.dataJSON.mandatory_config.sponsored ? 'Sponsored' : this.state.dataJSON.mandatory_config.subgenre
	                  )
	                ),
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      'div',
	                      { onClick: function onClick() {
	                          document.getElementsByClassName('totimelinecard')[0].classList.add('flipped');_this4.setState({ ready: true });
	                        }, className: 'call-to-action-button' },
	                      'Let\'s time travel'
	                    )
	                  )
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                { className: 'progress-line', id: 'progress_mobile' },
	                _react2.default.createElement(
	                  'div',
	                  { className: 'progress-start-lable' },
	                  topLabel
	    ...
	    value: function renderScreenshot() {
	      if (this.state.fetchingData) {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { id: 'protograph_div', className: 'protograph-card-div protograph-screenshot-mode' },
	            _react2.default.createElement(
	              'div',
	              { id: 'protograph_card_title_div' },
	              _react2.default.createElement(
	                'div',
	                { id: 'protograph_timeline_details_div', style: { width: '100%' } },
	                _react2.default.createElement(
	                  'h1',
	                  null,
	                  this.state.dataJSON.mandatory_config.timeline_title
	                ),
	                _react2.default.createElement(
	                  'p',
	                  null,
	                  this.state.dataJSON.mandatory_config.timeline_description
	                ),
	                _react2.default.createElement(
	                  'button',
	                  { id: 'protograph_show_main_card_button', style: { padding: '8px 10px', marginTop: 0 }, onClick: function onClick(e) {
	                      return that.showMainCard(e);
	                    } },
