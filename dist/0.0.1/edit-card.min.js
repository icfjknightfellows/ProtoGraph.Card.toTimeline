	...
	var TimelineCard = function (_React$Component) {
	  ...
	  _createClass(TimelineCard, [{
	    ...
	    value: function componentDidUpdate() {
	      var events = Array.from(document.getElementsByClassName('proto-single-event')),
	    ...
	    value: function renderLaptop() {
	      ...
	      if (this.state.fetchingData) {
	        ...
	        return _react2.default.createElement(
	          'div',
	          { className: 'proto-totimelinecard proto-parent-card-desktop' },
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  { onClick: function onClick() {
	                      document.getElementsByClassName('proto-totimelinecard')[0].classList.add('proto-flipped');_this3.setState({ ready: true });
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'proto-col-3 proto-view-in-desktop', style: { opacity: "0.3" } },
	              _react2.default.createElement('div', { className: 'proto-tag-area' }),
	              _react2.default.createElement(
	                'div',
	                { className: 'proto-cover-content', style: { bottom: 52 } },
	                _react2.default.createElement(
	                  'div',
	                  { className: 'proto-title' },
	                  data.mandatory_config.timeline_title
	    ...
	    value: function renderMobile() {
	      ...
	      if (this.state.fetchingData) {
	        ...
	        return _react2.default.createElement(
	          'div',
	          { className: 'proto-totimelinecard proto-parent-card-mobile' },
	          _react2.default.createElement(
	            'div',
	            { className: 'proto-first-view proto-view' },
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'div',
	                  { className: 'proto-card-tags', style: { position: "absolute", top: 0 } },
	                  fav ? _react2.default.createElement(
	                    'div',
	                    { className: 'proto-publisher-icon', style: { backgroundColor: this.state.dataJSON.mandatory_config.iconbgcolor || 'white' } },
	                    _react2.default.createElement('img', { className: 'proto-favicon', src: fav })
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      'div',
	                      { onClick: function onClick() {
	                          document.getElementsByClassName('proto-totimelinecard')[0].classList.add('proto-flipped');_this4.setState({ ready: true });
	                        }, className: 'proto-call-to-action-button' },
	                      'Let\'s time travel'
	                    )
	                  )
